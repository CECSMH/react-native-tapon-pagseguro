...
namespace margelo::nitro {
  ...
  template <>
  struct JSIConverter<margelo::nitro::taponpagseguro::InstallmentTypes> final {
    static inline margelo::nitro::taponpagseguro::InstallmentTypes fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      int enumValue = JSIConverter<int>::fromJSI(runtime, arg);
      return static_cast<margelo::nitro::taponpagseguro::InstallmentTypes>(enumValue);
    }
    static inline jsi::Value toJSI(jsi::Runtime& runtime, margelo::nitro::taponpagseguro::InstallmentTypes arg) {
